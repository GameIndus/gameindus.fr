        ...
        <div class="user-account-container row-container" style="min-height:320px">
            ...
            <div class="games-container">
                <div class="user-games">
                    ...
                    <a href="project/create" title="Créer un nouveau jeu">
        ...
        <div class="user-account-container row-container" style="margin:0 auto">
            <div class="left-column">
                @if (Auth::user()->isPremium())
                    ...
                    <div style="margin-left:25px">
                        <p>
                            ...
                            Il vous reste <b><?php //simpleFormatDate(remainingTimePremium($d)); ?></b> d'abonnement.
                            <br>Prend fin le <i>{{ Auth::user()->premiumSubscription()->end_at->format('d/m/Y à H:i') }}</i>.
                        </p>
                        <br>

                        <a href="premium/renew" title="Renouveller mon abonnement">
                        ...
                        <a href="premium/orders" title="Mes commandes">
                ...
                @else
                    ...
                    <a href="premium" title="Souscrire à un abonnement premium">
                    ...
                    <div id="modal-wheel-container" data-process-url="account/wheelprocess">
                ...
                <p>
                    ...
                    <?php if (true || !getUser()->friend_key_activated): ?>
                ...
                <br>
                <?php if (true || !getUser()->friend_key_activated): ?>
                <a href="account/generatefriendkey" title="Générer une clé pour un ami">
                ...
                <div class="input" style="margin:0">
                    ...
                    <input type="text" id="friendKey"
                           ...
                           readonly value="XXXX-XXXX-XXXX-XXXX" />
            ...
            <div class="right-column">
                ...
                <div class="small-table">
                    ...
                    <?php if (true || count($d->projectsFollowed) == 0): ?>
