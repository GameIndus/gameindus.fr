...
@section('content')
    <div class="account-container">
        ...
        <div class="user-account-container row-container">
            <form method="post" action="{{ route('account.update') }}" id="accountedit-form">
                @csrf

                <div class="left-column form-container" style="margin-top:20px">
                    <h3 class="subtitle"
                        style="font-size:1.4em;text-align:left;font-weight:bold;font-family:'Open Sans',Helvetica,Arial,serif">
                ...
                <div class="right-column form-container" style="margin-top:20px">
                    <h3 class="subtitle"
                        style="font-size:1.4em;text-align:left;font-weight:bold;font-family:'Open Sans',sans-serif">
                        Informations secondaires</h3>

                    <div class="input">
                        <label for="website">Site internet</label>
                        <input type="text" name="website" id="website" placeholder="Votre site internet"
                               value="https://" autocomplete="off">
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <img src="https://www.arcticnorth.ca/skin/frontend/fengo/default/images/chestnut/avatar/avatar.png" alt="Mon avatar courant"
                ...
                <div class="responsive-column" style="margin-top:0">
                        ...
                        <div class="input" style="margin:0">
                            ...
                            <div style="display:block;position:absolute;right:50px;top:-2px">
                                <input type="checkbox" name="newsletter" id="newsletter"
                                       class="css-checkbox"<?php if (false && $d->newsletter): echo " checked"; endif; ?> />
                    ...
                    <div class="right-column" style="margin: 10px 5% 10px 0;">
                        <div class="input" style="margin:0">
