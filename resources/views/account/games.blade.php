        ...
        <div class="user-account-container row-container">
            ...
            <div class="games-container">
                <div class="user-games">
                    ...
                    <div class="user-game">
                        <div class="preview"
                             style="background-image:url(project/preview/<?= $v->id ?>/232/163)"></div>
                        <div class="meta">
                            <div class="infos">
            ...
            <a href="project/create" title="Créer un nouveau projet">
                <div class="btn btn-success" style="width:220px;font-size:0.9em">
