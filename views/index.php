...
<div class="row-container features-container">
    ...
    <p style="text-align:center;font-size:1.1em;font-family:'Open Sans',Helvetica,Arial,sans-serif">GameIndus est une
        plateforme regroupant un ensemble d'outils vous permettant de créer vos jeux vidéo : création de cartes,
        d'images animées, de scènes de jeu, etc. Du navigateur jusqu'au mobile, grâce à GameIndus vous avez toutes les
    ...
    <div class="features">
        ...
        <div class="feature">
            ...
            <p>
                &nbsp;&nbsp;Sur GameIndus, la création d'un jeu vidéo est possible <b>sans compétences particulières</b>,
        ...
        <div class="feature">
            ...
            <p>
                &nbsp;&nbsp;Certains services limitent les utilisateurs dans leur création. À l'inverse, GameIndus vous
...
<div class="row-container games-container">
    ...
    <div class="row-container">
        <div class="left-games-container">
            ...
            <p>
                Avec GameIndus, vous pouvez créer des jeux vidéo complets facilement et rapidement. Voici les derniers
                jeux vidéo réalisés par les membres du site.
            </p>

            <a href="<?= BASE ?>galerie" title="Plus de jeux >">
                <div class="view-more">En voir plus &nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i></div>
            </a>
        </div>
        <div class="user-games">
            <?php foreach ($d->projs as $v): ?>
                <a href="<?= BASE . 'project/' . $v->id ?>" title="En savoir +">
                    <div class="user-game">
                        <div class="preview"
                             style="background-image:url(<?php if ($v->image == "/imgs/projects/unknown.png"): ?><?= BASE ?>project/preview/noimage/232/163<?php else: ?><?= BASE ?>project/preview/<?= $v->id ?>/232/163<?php endif; ?>);"></div>
                        <div class="meta">
    ...
    <div class="row-container">
        <div class="left-getstarted-container">
            ...
            <p style="font-size:1em;font-family:'Open Sans',Helvetica,Arial,sans-serif">
                Apprendre sur GameIndus est très simple. Nous fournissons des tutoriels écrits et vidéos<br>pour vous
            ...
            <div class="getstarted-tools">
                ...
                <a href="<?= BASE ?>helpcenter" title="Support" target="_blank">
                    <div class="getstarted-tool">
